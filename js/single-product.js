jQuery(function (t) {
  ...
  (t('body')
    ...
    .on('keydown', '.wc-tabs li a, ul.tabs li a', function (e) {
      ...
      if ([a, r, n, s, c, l].includes(o)) {
        ...
        ('vertical' !== m || (o !== r && o !== a)) &&
          ...
          (e.preventDefault(),
          (o === r && 0 === g && 'horizontal' === m) || (o === s && 0 === g && 'vertical' === m) || o === c
            ? (u = h)
            : ((a === o && g === h && 'horizontal' === m) || (n === o && g === h && 'vertical' === m) || o === l) &&
              (u = 0),
          p.eq(u).focus());
      }
    })
    ...
    .on('click', '#respond p.stars a', function () {
      ...
      return (
        o.val(i),
        e.siblings('a').removeClass('active').attr('aria-checked', 'false').attr('tabindex', '-1'),
    ...
    .on('keyup', '.wc-tabs li a, ul.tabs li a, #respond p.stars a', function (e) {
      ...
      o.concat(['ArrowLeft', 'ArrowUp']).includes(i) &&
        (e.preventDefault(),
        e.stopPropagation(),
        o.includes(i) ? t(this).next().focus().click() : t(this).prev().focus().click());
    }),
    ...
    (e.prototype.initPhotoswipe = function () {
      this.zoom_enabled && this.$images.length > 0
        ? (this.$target.prepend(
          ...
          this.$target.on('keydown', '.woocommerce-product-gallery__trigger', (t) => {
